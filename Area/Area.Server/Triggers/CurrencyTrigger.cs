...
{
    public class CurrencyTrigger : ITrigger
    {
        ...
        public CurrencyTrigger(ReactionEnum _reaction, string _params)
        {
            Reaction = _reaction;
            Params = _params;
            running = false;
        ...
        private void Work()
        {
            string data = CurrencyService.GetCurrenciesValues();
            string title = "Currency Update " + DateTime.Now.ToString();
        ...
        public override void Start()
        {
            if (running)
                return;
            Logger.Debug("Currency trigger started.");
