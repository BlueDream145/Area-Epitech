...
{
    public class WeatherTrigger : ITrigger
    {
        ...
        public WeatherTrigger(ReactionEnum _reaction, string _params)
        {
            Reaction = _reaction;
            Params = _params;
            running = false;
        ...
        private void Work()
        {
            string data = WeatherService.GetWeatherByLocation(Params);
            string title = "Weather Update " + DateTime.Now.ToString();
        ...
        public override void Start()
        {
            if (running)
                return;
            Logger.Debug("Weather trigger started.");
